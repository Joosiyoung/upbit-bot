...
| 2 | ~~[코인] 신호 재설계~~ ✅ **채택 완료 (2026-07-14)** | — | §2 참조. bb-off+레짐게이트+th13 채택기준 최초 통과 → 코드 반영 |
...
### 2. [채택 완료 2026-07-14] 신호 재설계

#### 2.1 중간 실측 — 섀도우 실측 + BB 재검증 (2026-07-08)
...
#### 2.2 채택 완료 — BB 추격 가점 제거 + 임계치 13 + 시뮬 레짐 정합화 (2026-07-14)
